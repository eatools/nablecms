...
<tr class="tr_bg">
    <td>页面地址</td>
    <td ><input type="text" name="uri" value="index"><i>(前台显示的路径编码,如果为首页，请填写index)</i></td>
</tr>

<tr class="tr_bg">
    <td>缓存时间</td>
    <td><input type="text" name="cache_time" value="0"> <i>分，(页面缓存时间，指定时间内更新数据)</i></td>
</tr>

<tr class="tr_bg">
    <td>排序</td>
    <td><input type="text" name="orderby" value="100"> <i>降序排列</i></td>
</tr>
...
<tr class="tr_bg">
    <td>状态</td>
    <td>
    <input type="radio" name="is_del" value="0" >显示 <input type="radio" name="is_del" value="1" checked>隐藏 <i>(只有启用后才有效！)</i>
    </td>
</tr>
